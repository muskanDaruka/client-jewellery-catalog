    ...
    return (
        <div className='relative w-full h-screen'>
            <Image
                ...
                priority
            />
            <div className='absolute left-[30%] xl:top-[12%] mt-1 flex justify-between items-center gap-10 w-2/3'>
                <h1 className='xl:text-5xl text-base font-bold '>ABOUT US</h1>
            ...
            <div className='absolute xl:top-[20%] mt-6 left-[30%] xl:right-10'>
                <p className='font-normal xl:text-xl text-xs xl:pb-2 pb-0'>
